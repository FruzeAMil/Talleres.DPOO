...
public class SandboxMapas
{
    ...
    {
    	List<String> valoresUni = new ArrayList<>();
        for (String valor : mapaCadenas.values()) {
            if (!valoresUni.contains(valor)) {
                valoresUni.add(valor);
            }
        }
        return valoresUni.size();
    }
    ...
    {
    	List<String> llavesAElim = new ArrayList<>();
        for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
            if (entry.getValue().equals(valor)) {
                llavesAElim.add(entry.getKey());
            }
        }
        for (String llave : llavesAElim) {
            mapaCadenas.remove(llave);
        }
    }
